...
public class TestNonMeteredEntitlements_Revoke
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS6106-CJ/src/entitlements/entitlements-facade/src/test/resources/atdd/suites/NonMeteredEntitlements_Revoke.txt"));
        }
