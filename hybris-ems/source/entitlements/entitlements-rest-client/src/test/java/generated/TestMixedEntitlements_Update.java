...
public class TestMixedEntitlements_Update
{
	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			"/opt/bamboo-agent/xml-data/build-dir/HYM-EMS6106-CJ/src/entitlements/entitlements-rest-client/src/test/resources/atdd/suites/MixedEntitlements_Update.txt"));
        }
